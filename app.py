...
try:
    ...
    if model is None:
        ...
        connected_model_name = "models/gemini-1.5-flash (기본)"

    st.sidebar.success(f"🚀 연결 성공: {connected_model_name}")
